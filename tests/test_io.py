...
class TestPascalVocRW(unittest.TestCase):
    def test_upper(self):
        ...
        self.assertEqual(
            person_bnd_box[1], [(60, 40), (430, 40), (430, 504), (60, 504)]
        )
...
class TestCreateMLRW(unittest.TestCase):
    def test_a_write(self):
        ...
        person = {
            "label": "person",
            "points": ((65, 45), (420, 45), (420, 512), (65, 512)),
        }
        face = {
            "label": "face",
            "points": ((245, 250), (350, 250), (350, 365), (245, 365)),
        }
        ...
        self.assertEqual(
            "test.512.512.bmp", data_dict["image"], "filename not correct in .json"
        )
        self.assertEqual(
